...
- [x] Sudah mengunduh **_Jar Hadoop Common_** pada link [**_di sini_**](https://https://mvnrepository.com/artifact/org.apache.hadoop/hadoop-common). *Pastikan Anda mengunduh versi **Jar** nya sesuai dengan versi **Hadoop** Anda*.
  > Bagi Anda user **Linux** dan Anda juga ingin menggunakan **Hadoop Common versi 3.2.2**, Anda dapat menggunakan perintah berikut ini: **`$ wget https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-common/3.2.2/hadoop-common-3.2.2.jar`** 
- [x] Sudah mengunduh **_Jar Hadoop MapReduce Core_** pada link [**_di sini_**](https://https://mvnrepository.com/artifact/org.apache.hadoop/hadoop-mapreduce-client-core). *Pastikan Anda mengunduh versi **Jar** nya sesuai dengan versi **Hadoop** Anda*.
  > Bagi Anda user **Linux** dan Anda juga ingin menggunakan **Hadoop MapReduce Client Core versi 3.2.2**, Anda dapat menggunakan perintah berikut ini: **`$ wget https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-common/3.2.2/hadoop-mapreduce-client-core-3.2.2.jar`**
